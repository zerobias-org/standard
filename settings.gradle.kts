// settings.gradle.kts — standard monorepo
//
...
rootProject.name = "standards"

// Auto-discover standard packages under package/. Standards live four
// directories deep — package/<type>/<vendor>/<suite>/<version>/ — so the
// marker walk picks up build.gradle.kts at any depth.
